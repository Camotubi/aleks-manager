				...
				<tr>
					<td>
						<div class="mail-content column ">
                            ...
                            <p>Esta semana has aprendido <strong>@if(isset($student)){{number_format($student->progressSinceLastWeek(),2,',',' ')}}@else BLANK @endif</strong> temas nuevos en tu Módulo de Preparación. ¡Felicidades! Estás avanzando a buen paso, sigue así <span style="font-size:20px;">😊</span>.</p>
